...
# Check accuracy
score = model.evaluate_generator(validation_generator, 3533 // batch_size)
print("TEST")
print(score)
...
"""
# callback functions
save_best = ModelCheckpoint('VGG16_regular_ninth_try2_PRIVATE_TEST2.h5', monitor='val_acc', verbose=2, save_best_only=True,
                              mode='max')
